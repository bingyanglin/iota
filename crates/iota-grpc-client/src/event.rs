...
// TODO: Re-enable when event proto is fully implemented
// use anyhow::anyhow;
// use futures::{Stream, StreamExt};
// use iota_grpc_types::v0::event as grpc_event;
...
//     client: grpc_event::event_service_client::EventServiceClient<Channel>,
// }
//
// impl EventClient {
...
//         Self {
//             client: grpc_event::event_service_client::EventServiceClient::new(channel),
//         }
//     }
//
...
//         &mut self,
//         filter: grpc_event::EventFilter,
//     ) -> Result<impl Stream<Item = Result<IotaEvent, tonic::Status>>, tonic::Status> {
//         let request = grpc_event::EventStreamRequest {
//             filter: Some(filter),
//         };
...
//     fn deserialize_event(event: &grpc_event::Event) -> anyhow::Result<IotaEvent> {
//         let event_id = event
//             .event_id
//             .as_ref()
