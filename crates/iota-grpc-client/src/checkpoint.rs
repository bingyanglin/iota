...
// TODO: Re-enable when checkpoint proto is fully implemented
// use futures::{Stream, StreamExt};
// use iota_grpc_types::{
//     checkpoints::{CertifiedCheckpointSummary, CheckpointData},
//     v0::checkpoint as grpc_checkpoint,
// };
...
//     client: grpc_checkpoint::checkpoint_service_client::CheckpointServiceClient<Channel>,
// }
//
...
//         Self {
//             client: grpc_checkpoint::checkpoint_service_client::CheckpointServiceClient::new(
//                 channel,
//             ),
//         }
//     }
...
//         let request = grpc_checkpoint::CheckpointStreamRequest {
...
//         let request = grpc_checkpoint::EpochRequest { epoch };
//         let response = self
//             .client
...
//         checkpoint: &grpc_checkpoint::Checkpoint,
