...
mod _field_impls {
    ...
    use crate::v0::checkpoint::Checkpoint;
    #[allow(unused_imports)]
    use crate::v0::checkpoint::CheckpointFieldPathBuilder;
    #[allow(unused_imports)]
    ...
    #[allow(unused_imports)]
    use crate::v0::filter::EventFilterFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::filter::TransactionFilter;
    #[allow(unused_imports)]
    use crate::v0::filter::TransactionFilterFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::ledger_service::EndMarker;
    #[allow(unused_imports)]
    use crate::v0::ledger_service::EndMarkerFieldPathBuilder;
    #[allow(unused_imports)]
    ...
    #[allow(unused_imports)]
    use crate::v0::types::ObjectReference;
    #[allow(unused_imports)]
    ...
    impl CheckpointDataFieldPathBuilder {
        ...
        pub fn end_marker(mut self) -> EndMarkerFieldPathBuilder {
            self.path.push(CheckpointData::END_MARKER_FIELD.name);
            EndMarkerFieldPathBuilder::new_with_base(self.path)
        }
    }
