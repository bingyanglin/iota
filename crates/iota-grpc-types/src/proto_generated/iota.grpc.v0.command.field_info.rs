...
mod _field_impls {
    ...
    #[allow(unused_imports)]
    use crate::v0::command::GasCoin;
    #[allow(unused_imports)]
    use crate::v0::command::GasCoinFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::command::Input;
    #[allow(unused_imports)]
    use crate::v0::command::InputFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::command::Result;
    #[allow(unused_imports)]
    use crate::v0::command::ResultFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::command::Unknown;
    #[allow(unused_imports)]
    use crate::v0::command::UnknownFieldPathBuilder;
    #[allow(unused_imports)]
    use crate::v0::types::TypeTag;
    #[allow(unused_imports)]
    use crate::v0::types::TypeTagFieldPathBuilder;
    impl Argument {
    ...
    impl ArgumentFieldPathBuilder {
        ...
        pub fn unknown(mut self) -> UnknownFieldPathBuilder {
            self.path.push(Argument::UNKNOWN_FIELD.name);
            UnknownFieldPathBuilder::new_with_base(self.path)
        }
        pub fn gas_coin(mut self) -> GasCoinFieldPathBuilder {
            self.path.push(Argument::GAS_COIN_FIELD.name);
            GasCoinFieldPathBuilder::new_with_base(self.path)
        }
        pub fn input(mut self) -> InputFieldPathBuilder {
            self.path.push(Argument::INPUT_FIELD.name);
            InputFieldPathBuilder::new_with_base(self.path)
        }
        pub fn result(mut self) -> ResultFieldPathBuilder {
            self.path.push(Argument::RESULT_FIELD.name);
            ResultFieldPathBuilder::new_with_base(self.path)
        }
    }
    impl CommandOutput {
