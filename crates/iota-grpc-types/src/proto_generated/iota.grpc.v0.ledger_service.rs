...
pub mod object_result {
    ...
    pub enum Result {
        ...
        #[prost(message, tag = "2")]
        Error(super::super::google_rpc::Status),
    }
}
#[derive(Clone, PartialEq, ::prost::Message)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/iota.grpc.v0.ledger_service.LedgerService/GetServiceInfo",
            );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/iota.grpc.v0.ledger_service.LedgerService/GetObjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/iota.grpc.v0.ledger_service.LedgerService/GetTransactions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/iota.grpc.v0.ledger_service.LedgerService/GetEpoch",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod ledger_service_server {
    ...
    pub const SERVICE_NAME: &str = "iota.grpc.v0.ledger_service.LedgerService";
